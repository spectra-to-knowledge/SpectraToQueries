...
[![Codecov test coverage](https://codecov.io/gh/adafede/SpectraToQueries/graph/badge.svg)](https://app.codecov.io/gh/adafede/SpectraToQueries)
<!-- badges: end -->
...
- A file containing spectra grouped by classes to extract class-specific queries (the one of the MIADB is attached as demo).
